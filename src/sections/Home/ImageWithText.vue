  ...
  >
    <div class="container justify-center">
      ...
      >
        ...
        >
          <h2 v-if="block.heading" class="h3 mb16 heading-section-giva is-capitalized">{{ block.heading }}</h2>
        ...
        <template v-for="(block, index) in settings.blocks">
          ...
          >
            ...
            <div class="content has-text-white mb4" :class="textAnimation">
              <h2 v-if="block.heading" class="h3 has-text-white heading-section-giva is-capitalized">{{
                block.heading
              }}</h2>
